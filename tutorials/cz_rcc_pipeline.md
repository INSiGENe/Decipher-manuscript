# Analysis Pipeline for the Renal Cell Carcinoma (cz_rcc) Dataset

This document outlines the full analysis pipeline for the `cz_rcc` dataset, which contains single-cell transcriptomic data from Renal cell carcinoma patients.
...
"cz_rcc": {
  "dataset_description":{
    ...
    "download_url": "https://datasets.cellxgene.cziscience.com/bf28d870-0750-443d-bb54-ec664b8f40c3.h5ad",
    "description": "Single-cell transcriptomic datasets of Renal cell carcinoma patients",
    "abbreviation": "cz_rcc"
  },
  "pre_processing":{
    "input_path": "data/cz_rcc",
    "output_path": "data/cz_rcc",
    "step": "preprocessing",
    "subset_logic": {
      "disease": ["nonpapillary renal cell carcinoma", "normal"]
    },
    "min_genes_per_cell": 200
  },
  "pre_processing_for_analysis": {
    "input_path": "data/cz_rcc/preprocessing",
    "output_path": "results/cz_rcc",
    "cluster_meta_field": "cell_type",
    "condition_meta_field": "disease",
    "individual_meta_field": "donor_id",
    "case_condition": "nonpapillary renal cell carcinoma",
...
# Run the script
python3 scripts/analysis_cellxgene_datasets/1_preprocess_h5ad.py cz_rcc
```
...
# Run the script
Rscript scripts/analysis_cellxgene_datasets/2_preprocess_object_for_analysis.R cz_rcc
```
...
# Run the script
bash scripts/analysis_cellxgene_datasets/3_cytosig_run.sh cz_rcc
```
...
# Run the script
python3 scripts/analysis_cellxgene_datasets/5_cell_oracle.py cz_rcc
```
...
# Run the script
Rscript scripts/analysis_cellxgene_datasets/6_decipher_pipeline_v1_modularized.R cz_rcc
```
...
# Run the script
Rscript scripts/analysis_cellxgene_datasets/7_connectome_analysis.R cz_rcc
```
...
# Run the script
Rscript scripts/analysis_cellxgene_datasets/8_nichenet_analysis.R cz_rcc
```
...
# Run the script
bash scripts/analysis_cellxgene_datasets/9_natmi_analysis.sh cz_rcc
```
...
# Run the script
python3 scripts/analysis_cellxgene_datasets/10_liana_plus_analysis.py cz_rcc
```
