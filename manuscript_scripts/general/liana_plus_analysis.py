...
parser = argparse.ArgumentParser(description="Run LIANA+ using config.json")
...
liap = cfg["liana_plus_analysis"]
dataset_path = liap["dataset_path"]
sample_key = liap["sample_key"]
groupby = liap["groupby"]
condition_key = liap["condition_key"]
