...
base_dir = 'results/cord_pic/cytosig'

# Define output paths for P values and Z scores
p_value_output_path = 'results/cord_pic/cytosig/0_outputs/p_value'
z_score_output_path = 'results/cord_pic/cytosig/0_outputs/z_score'
