...
combined_seurat <- subset(combined_seurat, idents != "9")
combined_seurat <- subset(combined_seurat, idents != "4")
combined_seurat <- subset(combined_seurat, idents != "11")
combined_seurat <- subset(combined_seurat, idents != "15")



ref_deg <- read.csv("data/SevMilCOVID/SevMilCOVID19_cluster_labels.csv", stringsAsFactors = FALSE)
