#Please run 1_load_all_results.r first
#then execute the code below within the same docker environment
...
for (dataset in names(results_for_correlation)) {
  ...
  # Compute correlation & search space
  # it's wasteful to run this again but it's ok
  interaction_results_correlation_search_space <- getInteractionCorrelationAndSearchSpaceBetweenMethods(results_for_correlation[[dataset]])
...
# ---- figure 2f in 2a_robustness_bencharming.R ----
# ---- figure 2g ----
plotDecipherPrioritizedMap("results/lupus",top_n=8,dataset_name="lupus", abs_decipher_plot_limit = 20)
# find in results/lupus/figure
...
#alll
plotDecipherPrioritizedMap("results/SevCOVID_Azimuthl2",top_n=5,dataset_name="SevCOVID_Azimuthl2_all", abs_decipher_plot_limit = 20,width=21,height=9)
plotDecipherPrioritizedMap("results/MilCOVID_Azimuthl2",top_n=5,dataset_name="MilCOVID_Azimuthl2_all", abs_decipher_plot_limit = 20,width=21,height=9)
