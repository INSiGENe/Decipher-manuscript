...
base_dir = 'manuscript_analysis/BCG/cytosig'

# Define output paths for P values and Z scores
p_value_output_path = 'manuscript_analysis/BCG/cytosig/0_outputs/p_value'
z_score_output_path = 'manuscript_analysis/BCG/cytosig/0_outputs/z_score'
