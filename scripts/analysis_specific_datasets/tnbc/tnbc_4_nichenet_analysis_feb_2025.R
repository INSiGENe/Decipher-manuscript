...
#parameters ----
case_condition = "E"
control_condition = "NE"
dataset_path <- "results/TNBC"
this_species = "human"
...
for(this_receiver_ct in unique(seuratObj$cluster)){
  ...
  DE_table_receiver = FindMarkers(object = seurat_obj_receiver, ident.1 = case_condition, ident.2 = control_condition, min.pct = 0.10) %>% rownames_to_column("gene")
